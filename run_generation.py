...
ALL_MODELS = sum((tuple(conf.pretrained_config_archive_map.keys()) for conf in (OpenAIGPTConfig, XLNetConfig, TransfoXLConfig, XLMConfig, CTRLConfig, T5Config, GPT2Config)), ())
